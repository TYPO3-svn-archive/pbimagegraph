...
class tx_pbimagegraph_Color
{
    ...
    {
        $return = tx_pbimagegraph_Color::_splitColor($hex);
        $return['hex'] = $hex;
        return $return;
    }
    ...
    {
        return tx_pbimagegraph_Color::hex2rgb(tx_pbimagegraph_Color::hsv2hex($h, $s, $v));
    }
    ...
    function allocateColor(&$img, $color) {
        $color = tx_pbimagegraph_Color::color2RGB($color);
    ...
    function color2RGB($color)
    {
        ...
        if ($color{0} == '#') {
            $c = tx_pbimagegraph_Color::hex2rgb($color);
        } else {
            $c = tx_pbimagegraph_Color::namedColor2RGB($color);
        }
...
// }}}
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/class.tx_pbimagegraph_color.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/class.tx_pbimagegraph_color.php']);
}
?>
