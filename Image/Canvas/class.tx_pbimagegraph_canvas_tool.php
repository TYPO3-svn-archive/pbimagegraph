 ...
 * @abstract
 */
class tx_pbimagegraph_Canvas_Tool
{
    ...
    {
        $sa = tx_pbimagegraph_Canvas_Tool::mirror($p1, $p2, $smoothFactor);
        $sb = tx_pbimagegraph_Canvas_Tool::mid($p2, $sa);

        $m = tx_pbimagegraph_Canvas_Tool::mid($p2, $factor);

        $pC = tx_pbimagegraph_Canvas_Tool::mid($sb, $m);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_tool.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_tool.php']);
}
?>