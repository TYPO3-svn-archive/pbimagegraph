 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Canvas/class.tx_pbimagegraph_canvas_withmap.php');
 ...
 * @abstract
 */
class tx_pbimagegraph_Canvas_GD extends tx_pbimagegraph_Canvas_WithMap
{
     ...
     * 
     * 'antialias' = {true|'driver'} tx_pbimagegraph implemented method. This method
     ...
     */
    function tx_pbimagegraph_Canvas_GD($param)
    {
        include_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Canvas/class.tx_pbimagegraph_canvas_color.php');

        parent::tx_pbimagegraph_Canvas_WithMap($param);
    ...
    function _color($color = false)
    {
        if (($color === false) || ($color === 'opague') || ($color === 'transparent')) {
            ...
            return tx_pbimagegraph_Canvas_Color::allocateColor($this->_canvas, $color);
        }
    }
    ...
    function _getFillStyle($fillStyle = false, $x0 = 0, $y0 = 0, $x1 = 0, $y1 = 0)
    {
        ...
        if ($fillStyle == 'transparent') {
            ...
            if (is_resource($this->_fillStyle)) {
                ...
                $startColor = tx_pbimagegraph_Canvas_Color::color2RGB(
                    ($this->_fillStyle['direction'] == 'radial' ?
                        $this->_fillStyle['end'] :
                        $this->_fillStyle['start']
                    )
                );
                $endColor = tx_pbimagegraph_Canvas_Color::color2RGB(
                    ($this->_fillStyle['direction'] == 'radial' ?
                        $this->_fillStyle['start'] :
                        $this->_fillStyle['end']
                    )
                ...
                for ($i = 0; $i < $count; $i ++) {
                    ...
                    $color = tx_pbimagegraph_Canvas_Color::allocateColor(
                        $this->_tileImage,
                        $color
                    );
    ...
    {
        include_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Canvas/class.tx_pbimagegraph_canvas_tool.php');
                ...
                (isset($lastPoint['P2Y'])))
            {
                ...
                if ($d > 0) {
                    ...
                    for ($t = 0; $t <= 1; $t = $t + $interval) {
                        $x = tx_pbimagegraph_Canvas_Tool::bezier(
                            $t,
                            $lastPoint['X'],
                            $lastPoint['P1X'],
                            $lastPoint['P2X'],
                        ...
                        $y = tx_pbimagegraph_Canvas_Tool::bezier(
                            $t,
                            $lastPoint['Y'],
                            $lastPoint['P1Y'],
                            $lastPoint['P2Y'],
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_gd.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_gd.php']);
}
?>