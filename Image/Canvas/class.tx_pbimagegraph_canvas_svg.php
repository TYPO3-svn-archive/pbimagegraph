 ...
 * @link       http://pear.php.net/pepr/pepr-proposal-show.php?id=212
 */
class tx_pbimagegraph_Canvas_SVG extends tx_pbimagegraph_Canvas
{
     ...
     */
    function tx_pbimagegraph_Canvas_SVG($param)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_svg.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_svg.php']);
}
?>