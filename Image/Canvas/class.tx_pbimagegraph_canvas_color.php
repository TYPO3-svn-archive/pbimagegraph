...
class tx_pbimagegraph_Canvas_Color extends tx_pbimagegraph_Color
{
    ...
    * an array of rgb values.
    *
    * @param    mixed         any color representation supported by tx_pbimagegraph_Canvas_Color::color2RGB()
    ...
    */
    ...
    {
        $this->color1 = tx_pbimagegraph_Canvas_Color::color2RGB($col1);
        $this->color2 = tx_pbimagegraph_Canvas_Color::color2RGB($col2);
    }
}
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_color.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_color.php']);
}
?>