 ...
 * @abstract
 */
class tx_pbimagegraph_Canvas_WithMap extends tx_pbimagegraph_Canvas
{

    /**
     * The image map
     * @var tx_pbimagegraph_Canvas_ImageMap
     * @access private
     */
    var $_imageMap = null;
     ...
     * @abstract
     */
    function tx_pbimagegraph_Canvas_WithMap($params)
    {
        parent::tx_pbimagegraph_Canvas($params);
                
        if ((isset($params['usemap'])) && ($params['usemap'] === true)) {
            $this->_imageMap =& tx_pbimagegraph_Canvas::factory(
                'ImageMap',
                array(
                    'left' => $this->_left,
                    'top' => $this->_top,
    ...
    /**
     * Get the imagemap
     * @return tx_pbimagegraph_ImageMap The image map (or false if none)
     */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_withmap.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_withmap.php']);
}
?>