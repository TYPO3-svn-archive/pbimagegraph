 ...
 * @since      version 0.2.0
 */
class tx_pbimagegraph_Canvas_ImageMap extends tx_pbimagegraph_Canvas
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_imagemap.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Canvas/class.tx_pbimagegraph_canvas_imagemap.php']);
}
?>