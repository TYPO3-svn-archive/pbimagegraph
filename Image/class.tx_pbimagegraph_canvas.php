...
class tx_pbimagegraph_Canvas {
     ...
     * @abstract
     */
    function tx_pbimagegraph_Canvas($params)
    {
    ...
    function setFont($fontOptions)
    {
        ...
        if ((!isset($this->_font['file'])) && (isset($this->_font['name']))) {
            ...
            $this->_font['file'] = tx_pbimagegraph_Canvas_Tool::fontMap($this->_font['name']);
        }
    }
    ...
    function line($params)
    {
        ...
        if (isset($params['end0'])) {
            $angle = tx_pbimagegraph_Canvas_Tool::getAngle($x1, $y1, $x0, $y0);
            $this->drawEnd(
                array(
                    'end' => $params['end0'], 
                    'x' => $params['x0'], 
        ...
        if (isset($params['end1'])) {
            $angle = tx_pbimagegraph_Canvas_Tool::getAngle($x0, $y0, $x1, $y1);
     ...
     * <code>
     * <?php
     * $Canvas =& tx_pbimagegraph::factory('png', 
     ...
     * @return tx_pbimagegraph_Canvas The newly created canvas
     * @static
     */
    function &factory($canvas, $params)
    {
        ...
        $class = 'tx_pbimagegraph_Canvas_'. $canvas;
        include_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Canvas/' . dirname(str_replace('_', '/', $canvas)) . '/class.'. strtolower($class) . '.php');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/class.tx_pbimagegraph_canvas.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/class.tx_pbimagegraph_canvas.php']);
}
?>