...
class tx_pbimagegraph_Dataset
{
    ...
    /**
     * tx_pbimagegraph_Dataset [Constructor]
     */
    function tx_pbimagegraph_Dataset()
    {
    }
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_dataset.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_dataset.php']);
}
?>