 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Graph/Layout/class.tx_pbimagegraph_layout_horizontal.php');
 ...
 * Fx. a {@link tx_pbimagegraph_Layout_Horizontal} can layout two VerticalLayout's to
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Layout_Vertical extends tx_pbimagegraph_Layout_Horizontal
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_vertical.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_vertical.php']);
}
