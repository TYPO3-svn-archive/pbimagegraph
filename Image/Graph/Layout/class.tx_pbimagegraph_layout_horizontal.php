 ...
 * Fx. a HorizontalLayout can layout two {@link tx_pbimagegraph_Layout_Vertical}s to
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Layout_Horizontal extends tx_pbimagegraph_Layout
{
     ...
     */
    function tx_pbimagegraph_Layout_Horizontal(& $part1, & $part2, $percentage = 50)
    {
        parent::tx_pbimagegraph_Layout();
        if (!is_a($part1, 'tx_pbimagegraph_Layout')) {
            $this->_error(
                'Cannot create layout on non-layouable parts: ' . get_class($part1),
                array('part1' => &$part1, 'part2' => &$part2)
            );
        } elseif (!is_a($part2, 'tx_pbimagegraph_Layout')) {
            $this->_error(
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_horizontal.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_horizontal.php']);
}
?>