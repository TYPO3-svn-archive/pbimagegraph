 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Layout_Matrix extends tx_pbimagegraph_Layout
{
    ...
    /**
     * tx_pbimagegraph_Layout_Matrix [Constructor]
     *
     * @param int $rows The number of rows
     * @param int $cols The number of cols
     * @param bool $autoCreate Specifies whether the matrix should automatically
     *   be filled with newly created tx_pbimagegraph_Plotares objects, or they will
     *   be added manually
     */
    function tx_pbimagegraph_Layout_Matrix($rows, $cols, $autoCreate = true)
    {
     ...
     * @param int $row The row
     * @param int $col The column
     * @return tx_pbimagegraph_Layout The element of position ($row, $col) in the
     *   matrix
     */
     ...
     * @param int $row The row
     * @param int $col The column
     * @param tx_pbimagegraph_Layout $element The element to set in the position
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_matrix.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Layout/class.tx_pbimagegraph_layout_matrix.php']);
}
?>