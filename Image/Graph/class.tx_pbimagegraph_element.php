 ...
 *
 * The tx_pbimagegraph_Element can be drawn on the canvas, ie it has coordinates,
 * {@link tx_pbimagegraph_Line}, {@link tx_pbimagegraph_Fill}, border and background -
 ...
 * @abstract
 */
class tx_pbimagegraph_Element extends tx_pbimagegraph_Common
{
     ...
     *
     * @param tx_pbimagegraph_Fill $background The background
     * @see tx_pbimagegraph_Fill
     */
    function setBackground(& $background)
    {
        if (!is_a($background, 'tx_pbimagegraph_Fill')) {
            $this->_error(
     ...
     *
     * @param tx_pbimagegraph_Line $borderStyle The line style of the border
     * @see tx_pbimagegraph_Line
     */
    function setBorderStyle(& $borderStyle)
    {
        if (!is_a($borderStyle, 'tx_pbimagegraph_Line')) {
            $this->_error(
     ...
     *
     * @param tx_pbimagegraph_Line $lineStyle The line style of the element
     * @see tx_pbimagegraph_Line
     */
     ...
     *
     * @param tx_pbimagegraph_Fill $fillStyle The fill style of the element
     * @see tx_pbimagegraph_Fill
     */
    function setFillStyle(& $fillStyle)
    {
        if (!is_a($fillStyle, 'tx_pbimagegraph_Fill')) {
            $this->_error(
     ...
     *
     * @param tx_pbimagegraph_Font $font The font of the element
     * @see tx_pbimagegraph_Font
     */
    function setFont(& $font)
    {
        if (!is_a($font, 'tx_pbimagegraph_Font')) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_element.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_element.php']);
}
?>