 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Title extends tx_pbimagegraph_Layout
{
     ...
     * Create the title.
     *
     * Pass a tx_pbimagegraph_Font object - preferably by-ref (&amp;) as second
     ...
     */
    function tx_pbimagegraph_Title($text, $fontOptions = false)
    {
    ...
    function _done()
    {
        ...
        if (is_a($this->_parent, 'tx_pbimagegraph_Plotarea')) {            
            $this->_setCoords(
                $this->_parent->_left,
                $this->_parent->_top,
                $this->_parent->_right,
        ...
        } elseif (!is_a($this->_parent, 'tx_pbimagegraph_Layout')) {
            $this->_setCoords(
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_title.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_title.php']);
}
?>