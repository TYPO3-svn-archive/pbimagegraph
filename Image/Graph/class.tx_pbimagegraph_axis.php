 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
 class tx_pbimagegraph_Axis extends tx_pbimagegraph_Plotarea_Element
{
     ...
     * @var tx_pbimagegraph_DatePreProcessor
     * @access private
     * @see tx_pbimagegraph_DataPreProcessor
     */
    ...
    /**
     * tx_pbimagegraph_Axis [Constructor].
     * Normally a manual creation should not be necessary, axis are created
     * automatically by the {@link tx_pbimagegraph_Plotarea} constructor unless
     ...
     * axis)
     */
    function tx_pbimagegraph_Axis($type = IMAGE_GRAPH_AXIS_X)
    {
     ...
     *
     * @param tx_pbimagegraph_DataPreprocessor $dataPreProcessor The data preprocessor
     * @see tx_pbimagegraph_DataPreprocessor
     */
     ...
     * Sets options for the label at a specific level.
     *
     * The possible options are specified in {@link tx_pbimagegraph_Axis::
     * setLabelOption()}.
     *
     ...
     * @param tx_pbimagegraph_Font $font The font used for the title
     * @since 0.3.0dev2
     */
     ...
     *
     * @param tx_pbimagegraph_Dataset $dataset The dataset
     * @access private
     */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_axis.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_axis.php']);
}
?>