 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Graph/class.tx_pbimagegraph_plotarea.php');
 ...
 * to combine a map plot area with a {@link tx_pbimagegraph_Plot_Dot} using {@link
 * tx_pbimagegraph_Marker_PercentageCircle} as marker.
 *
 * @category   Images
 * @package    tx_pbimagegraph
 * @subpackage Plotarea
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Plotarea_Map extends tx_pbimagegraph_Plotarea
{
     ...
     */
    function tx_pbimagegraph_Plotarea_Map($map)
    {
        parent::tx_pbimagegraph_Plotarea();
    ...
    function _done()
    {
        ...
        return tx_pbimagegraph_Layout::_done();
    }

}
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plotarea/class.tx_pbimagegraph_plotarea_map.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plotarea/class.tx_pbimagegraph_plotarea_map.php']);
}
?>