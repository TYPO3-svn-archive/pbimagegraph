 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Plotarea_Radar extends tx_pbimagegraph_Plotarea
{

    /**
     * Create the plotarea, implicitely creates 2 normal axis
     */
    function tx_pbimagegraph_Plotarea_Radar()
    {
        parent::tx_pbimagegraph_Element();
        $this->_padding = 10;
        $this->_axisX =& tx_pbimagegraph::factory('tx_pbimagegraph_Axis_Radar');
        $this->_axisX->_setParent($this);
        $this->_axisY =& tx_pbimagegraph::factory('tx_pbimagegraph_Axis', IMAGE_GRAPH_AXIS_Y);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plotarea/class.tx_pbimagegraph_plotarea_radar.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plotarea/class.tx_pbimagegraph_plotarea_radar.php']);
}
?>