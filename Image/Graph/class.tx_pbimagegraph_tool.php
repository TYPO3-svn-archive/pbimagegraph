...
class tx_pbimagegraph_Tool
{
    ...
    {
        $sa = tx_pbimagegraph_Tool::mirror($p1, $p2, $smoothFactor);
        $sb = tx_pbimagegraph_Tool::mid($p2, $sa);

        $m = tx_pbimagegraph_Tool::mid($p2, $factor);

        $pC = tx_pbimagegraph_Tool::mid($sb, $m);
    ...
    { 
        ...
        $r1x = tx_pbimagegraph_Tool::close2zero(cos(deg2rad($v1)), 3); 
        $r2x = tx_pbimagegraph_Tool::close2zero(cos(deg2rad($v2)), 3);
        
        $r1y = tx_pbimagegraph_Tool::close2zero(sin(deg2rad($v1)), 3);
        $r2y = tx_pbimagegraph_Tool::close2zero(sin(deg2rad($v2)), 3);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_tool.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_tool.php']);
}
?>