 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Dataset_VectorFunction extends tx_pbimagegraph_Dataset
{
    ...
    /**
     * tx_pbimagegraph_VectorFunctionDataset [Constructor]
     *
     ...
     */
    function tx_pbimagegraph_Dataset_VectorFunction($minimumT, $maximumT, $functionX, $functionY, $points)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_vectorfunction.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_vectorfunction.php']);
}
?>