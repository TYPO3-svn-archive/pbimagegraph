 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Dataset_Function extends tx_pbimagegraph_Dataset
{
    ...
    /**
     * tx_pbimagegraph_FunctionDataset [Constructor]
     *
     ...
     */
    function tx_pbimagegraph_Dataset_Function($minimumX, $maximumX, $function, $points)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_function.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_function.php']);
}
?>