 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Graph/class.tx_pbimagegraph_dataset.php');
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Dataset_Trivial extends tx_pbimagegraph_Dataset
{
    ...
    /**
     * tx_pbimagegraph_Dataset_Trivial [Constructor]
     *
     ...
     * be used for ID tags, i.e. when using {@link tx_pbimagegraph_Fill_Array}. In
     ...
     */
    function tx_pbimagegraph_Dataset_Trivial($dataArray = false)
    {
        parent::tx_pbimagegraph_Dataset();
        $this->_data = array ();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_trivial.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Dataset/class.tx_pbimagegraph_dataset_trivial.php']);
}
?>