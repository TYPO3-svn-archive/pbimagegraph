 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Graph/Fill/class.tx_pbimagegraph_fill_image.php');
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Fill_Gradient extends tx_pbimagegraph_Fill //tx_pbimagegraph_Fill_Image
{
    ...
    /**
     * tx_pbimagegraph_GradientFill [Constructor]
     *
     ...
     */
    function tx_pbimagegraph_Fill_Gradient($direction, $startColor, $endColor)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Fill/class.tx_pbimagegraph_fill_gradient.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Fill/class.tx_pbimagegraph_fill_gradient.php']);
}
?>