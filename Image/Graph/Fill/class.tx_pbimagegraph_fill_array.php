 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Fill_Array extends tx_pbimagegraph_Fill
{
     ...
     *
     * @param tx_pbimagegraph_Fill $style The style to add
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Fill/class.tx_pbimagegraph_fill_array.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Fill/class.tx_pbimagegraph_fill_array.php']);
}
?>