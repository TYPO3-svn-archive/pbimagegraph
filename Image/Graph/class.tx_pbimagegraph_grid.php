 ...
 * tx_pbimagegraph_Grid_Lines}, which displays horizontal lines for every label on
 ...
 * @abstract
 */
class tx_pbimagegraph_Grid extends tx_pbimagegraph_Plotarea_Element
{
     ...
     *
     * @param tx_pbimagegraph_Axis $axis The axis
     * @access private
     */
    ...
    {
        if (is_a($this->_secondaryAxis, 'tx_pbimagegraph_Axis_Radar')) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_grid.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_grid.php']);
}
?>