 ...
 * @abstract
 */
class tx_pbimagegraph_Marker extends tx_pbimagegraph_Plotarea_Element
{
    ...
    {
        if (is_a($this->_secondaryMarker, 'tx_pbimagegraph_Marker')) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_marker.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_marker.php']);
}
?>