 ...
 * tx_pbimagegraph_Plot_Line}, but the area beneath the line is filled and the whole
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Plot_Area extends tx_pbimagegraph_Plot
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_area.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_area.php']);
}
?>