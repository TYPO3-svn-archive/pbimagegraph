 ...
 */
class tx_pbimagegraph_Plot_BoxWhisker extends tx_pbimagegraph_Plot
{
    /**
     * Whisker circle size
     * @var int
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_boxwhisker.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_boxwhisker.php']);
}
?>