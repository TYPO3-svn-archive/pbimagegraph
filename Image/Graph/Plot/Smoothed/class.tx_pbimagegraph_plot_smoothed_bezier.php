 ...
 * Used in {@link tx_pbimagegraph_Plot_Smoothed_Line} and {@link
 * tx_pbimagegraph_Plot_Smoothed_Area}. Smoothed charts are only supported with non-
 * stacked types
 ...
 * @abstract
 */
class tx_pbimagegraph_Plot_Smoothed_Bezier extends tx_pbimagegraph_Plot
{

    /**
     * tx_pbimagegraph_Plot_Smoothed_Bezier [Constructor]
     *
     ...
     *   tx_pbimagegraph_Legend})
     */
    function tx_pbimagegraph_Plot_Smoothed_Bezier(& $dataset, $title = '')
    {
        parent::tx_pbimagegraph_Plot($dataset, 'normal', $title);
    }
    ...
    function _getControlPoints($p1, $p0, $p2, $p3)
    {
        ...
        $pC1['X'] = tx_pbimagegraph_Tool::controlPoint($p0['X'], $p1['X'], $p2['X']);
        $pC1['Y'] = tx_pbimagegraph_Tool::controlPoint($p0['Y'], $p1['Y'], $p2['Y']);
        $pC2['X'] = tx_pbimagegraph_Tool::controlPoint($p3['X'], $p2['X'], $p1['X']);
        $pC2['Y'] = tx_pbimagegraph_Tool::controlPoint($p3['Y'], $p2['Y'], $p1['Y']);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/Smoothed/class.tx_pbimagegraph_plot_smoothed_bezier.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/Smoothed/class.tx_pbimagegraph_plot_smoothed_bezier.php']);
}
?>