 ...
 */
class tx_pbimagegraph_Plot_CandleStick extends tx_pbimagegraph_Plot
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_candlestick.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Plot/class.tx_pbimagegraph_plot_candlestick.php']);
}
?>