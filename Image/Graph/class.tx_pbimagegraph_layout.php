 ...
 * @abstract
 */
class tx_pbimagegraph_Layout extends tx_pbimagegraph_Plotarea_Element
{
    ...
    /**
     * tx_pbimagegraph_Layout [Constructor]
     */
    function tx_pbimagegraph_Layout()
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_layout.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/class.tx_pbimagegraph_layout.php']);
}
?>