 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Axis_Category extends tx_pbimagegraph_Axis
{
    ...
    /**
     * tx_pbimagegraph_Axis_Category [Constructor].
     *
     * @param int $type The type (direction) of the Axis
     */
    function tx_pbimagegraph_Axis_Category($type = IMAGE_GRAPH_AXIS_X)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/class.tx_pbimagegraph_axis_category.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/class.tx_pbimagegraph_axis_category.php']);
}
?>