 ...
 */
require_once(PATH_site.t3lib_extMgm::siteRelPath("pbimagegraph").'Image/Graph/Axis/class.tx_pbimagegraph_axis_category.php');
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Axis_Radar extends tx_pbimagegraph_Axis_Category
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/class.tx_pbimagegraph_axis_radar.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/class.tx_pbimagegraph_axis_radar.php']);
}
?>