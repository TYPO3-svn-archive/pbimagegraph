 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Axis_Marker_Area extends tx_pbimagegraph_Grid
{
     ...
     * [Constructor]
     */
    function tx_pbimagegraph_Axis_Marker_Area()
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/Marker/class.tx_pbimagegraph_axis_marker_area.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/Marker/class.tx_pbimagegraph_axis_marker_area.php']);
}
?>