 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Axis_Marker_Line extends tx_pbimagegraph_Grid
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/Marker/class.tx_pbimagegraph_axis_marker_line.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Axis/Marker/class.tx_pbimagegraph_axis_marker_line.php']);
}
?>