 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Figure_Ellipse extends tx_pbimagegraph_Element
{
     ...
     */
    function tx_pbimagegraph_Figure_Ellipse($x, $y, $radiusX, $radiusY)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Figure/class.tx_pbimagegraph_figure_ellipse.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Figure/class.tx_pbimagegraph_figure_ellipse.php']);
}
?>