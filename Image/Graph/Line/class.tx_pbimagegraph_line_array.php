 ...
 * multiple-/stackedbarchart you name the {@link tx_pbimagegraph_Dataset}s and uses
 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Line_Array extends tx_pbimagegraph_Common
{
     ...
     *
     * @param tx_pbimagegraph_Line $style The style to add
     */
    function add(& $style, $id = false)
    {
        if (is_a($style, 'tx_pbimagegraph_Element')) {
            parent::add($style);
        }
        if ($id === false) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_array.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_array.php']);
}
?>