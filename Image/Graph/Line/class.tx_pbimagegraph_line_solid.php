 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Line_Solid extends tx_pbimagegraph_Common
{
    ...
    /**
     * tx_pbimagegraph_SolidLine [Constructor]
     *
     * @param mixed $color The color of the line
     */
    function tx_pbimagegraph_Line_Solid($color)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_solid.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_solid.php']);
}
?>