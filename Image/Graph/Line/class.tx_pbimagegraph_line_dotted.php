 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Line_Dotted extends tx_pbimagegraph_Line_Formatted
{
     ...
     */
    function tx_pbimagegraph_Line_Dotted($color1, $color2)
    {
        parent::tx_pbimagegraph_Line_Formatted(array ($color1, $color2));
    }

}
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_dotted.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Line/class.tx_pbimagegraph_line_dotted.php']);
}
?>