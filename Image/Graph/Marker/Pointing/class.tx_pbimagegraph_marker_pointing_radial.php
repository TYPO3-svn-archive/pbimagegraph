 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Marker_Pointing_Radial extends tx_pbimagegraph_Marker_Pointing
{
     ...
     * the pin'
     */
    function tx_pbimagegraph_Marker_Pointing_Radial($radius, & $markerEnd)
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/Pointing/class.tx_pbimagegraph_marker_pointing_radial.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/Pointing/class.tx_pbimagegraph_marker_pointing_radial.php']);
}
?>