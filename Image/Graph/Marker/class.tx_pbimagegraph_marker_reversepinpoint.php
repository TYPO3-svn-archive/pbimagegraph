 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Marker_ReversePinpoint extends tx_pbimagegraph_Marker_Icon
{

    /**
     * Create the marker as a reverse pin point
     */
    function tx_pbimagegraph_Marker_ReversePinpoint()
    {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/class.tx_pbimagegraph_marker_reversepinpoint.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/class.tx_pbimagegraph_marker_reversepinpoint.php']);
}
?>