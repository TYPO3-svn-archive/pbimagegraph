 ...
 * @link       http://pear.php.net/package/tx_pbimagegraph
 */
class tx_pbimagegraph_Marker_Value extends tx_pbimagegraph_Marker
{
     ...
     *   X or Y value
     */
    function tx_pbimagegraph_Marker_Value($useValue = IMAGE_GRAPH_VALUE_X)
    {
     ...
     * @return tx_pbimagegraph_DataPreprocessor The data preprocessor
     */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/class.tx_pbimagegraph_marker_value.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pbimagegraph/Image/Graph/Marker/class.tx_pbimagegraph_marker_value.php']);
}
?>